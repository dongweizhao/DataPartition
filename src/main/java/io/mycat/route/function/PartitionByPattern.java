...
public class PartitionByPattern extends AbstractPartitionAlgorithm implements RuleAlgorithm {
	...
	public static void main(String[] args) {
		...
		partitionByPattern.defaultNode=2;
		partitionByPattern.patternValue=256;
		partitionByPattern.longRongs=new LongRange[]{new LongRange(0,1,32),new LongRange(1,33,64),new LongRange(2,65,96),new LongRange(3,97,128),new LongRange(4,129,160)
				,new LongRange(5,161,192),new LongRange(6,193,224),new LongRange(7,225,256)};

		System.out.println("args = [" + partitionByPattern.calculate("33")+ "]");
