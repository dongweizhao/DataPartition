...
public class PartitionByRangeMod extends AbstractPartitionAlgorithm implements RuleAlgorithm {
	...
	public static void main(String[] args) {
		PartitionByRangeMod partitionByRangeMod=new PartitionByRangeMod();
		partitionByRangeMod.setDefaultNode(10);
		partitionByRangeMod.longRanges=new LongRange[]{new LongRange(5,0,200),new LongRange(5,201,400),new LongRange(2,401,600)};
		System.out.println("args = [" + partitionByRangeMod.calculate("125") + "]");
	}
}
